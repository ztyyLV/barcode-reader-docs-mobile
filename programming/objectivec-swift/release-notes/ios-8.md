...
- Improved the [`confidence`]({{site.android_api}}auxiliary-ExtendedResult.html#confidecne) algorithm for 1D barcode results. Users can get even more accurate results by configuring the `confidence` filter.
