...
|---------- | ---- | ----------- |
| [`results`](#results) | *Object\[\]* | One of the following types: Array of [`Contour`](#contour), Array of [`ImageData`](#imagedata), Array of [`LineSegment`](#linesegment), Array of [`LocalizationResult`](#localizationresult), Array of [`RegionOfInterest`](#regionofinterest). |
...
`LineSegment` is one of the [`results`](#intermediateresult) type in `IntermediateResult`.
...
`RegionOfInterest` is one of the [`results`](#intermediateresult) type in `IntermediateResult`.
